...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/s2

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/s2: ${OBJECTFILES}
...
${OBJECTDIR}/Mayorista.o: Mayorista.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Mayorista.o Mayorista.cpp

${OBJECTDIR}/Ordenador.o: Ordenador.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Ordenador.o Ordenador.cpp
